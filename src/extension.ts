	...
	<div id="app">
		<div id="toolbar">
			...
			<div class="toolbar-actions">
				...
				<button type="button" id="diff-highlight-toggle" class="toolbar-btn" title="Highlight added and removed text since the comparison version, even without diff view open">Highlight changes</button>
